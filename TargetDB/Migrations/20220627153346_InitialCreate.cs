        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WLotNum = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetID = table.Column<int>(type: "int", nullable: false),
                    WarehouseID = table.Column<int>(type: "int", nullable: false),
                    WCode = table.Column<string>(type: "int", nullable: false),
                    WLotNum = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cyclotron_Warehouse_WCode",
                        column: x => x.WCode,
                        principalTable: "Warehouse",
                        principalColumn: "WCode",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cyclotron_Warehouse_WLotNum",
                        column: x => x.WLotNum,
                        principalTable: "Warehouse",
                        principalColumn: "WLotNum",
                        onDelete: ReferentialAction.Cascade);
                });;
